...
print("here")
phyDF = sqlContext.read.load('../training/*.psv',format='csv',sep='|',inferSchema='true',header='true')
...
vitals_data_df.repartition(1).write.csv('../training/output/out52.csv',header='true')
